...
import { fetchAllCategories, fetchContacts, fetchStoreProfile } from "@/api";
...
const Header = () => {
  ...
  const allContactQuery = useQuery({
  ...
  if (StoreProfileQuery.data)
    console.log(STORAGE_URL + StoreProfileQuery.data?.data?.store?.logo);
  // Sticky menu
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            {StoreProfileQuery.data?.data?.store?.logo ?
              <Link className="flex-shrink-0" href="/">
                <Image
                  src={STORAGE_URL + StoreProfileQuery.data?.data?.store?.logo}
                  alt="Logo"
                  width={64}
                  height={64}
              ...
              <Link className="flex-shrink-0" href="/">
                <p className="text-3xl font-bold">
                  {StoreProfileQuery.data?.data?.store?.store_name}
                </p>
              </Link>
            }
              ...
              <form>
                <div className="flex items-center">

                  {
                    ...
                    <CustomSelect options={allCategoriesQuery.data?.data?.categories} />
                  }
          ...
          <div className="flex w-full lg:w-auto ms-auto justify-end items-center gap-5">
          ...
          {/* <!-- header top right --> */}
          {
            allContactQuery.data?.data?.contacts?.phone
            &&
            <div className="flex w-full lg:w-auto items-center gap-7.5">
              <div className="hidden xl:flex items-center gap-3.5">
                ...
                <a href={'tel:' + allContactQuery.data?.data?.contacts.phone}>
      ...
      <div className="border-t border-gray-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            {/* <!--=== Main Nav Start ===--> */}
            <div
              className={`w-[240px] absolute right-4 top-full xl:static xl:w-auto h-0 xl:h-auto invisible xl:visible xl:flex items-center justify-between z-50 ${navigationOpen &&
