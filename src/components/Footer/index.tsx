        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 xl:gap-12 pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="w-full">
            ...
            <ul className="flex flex-col gap-4">
              {
                contactsQuery?.data?.data?.contacts?.address &&
                <li className="flex gap-4.5">
                  ...
                  <div className="text-gray-600 text-sm">
                    ...
                    <p>{contactsQuery?.data?.data?.contacts.address}</p>
                  </div>
                </li>}

              {contactsQuery.data?.data?.contacts?.phone &&
                <li className="flex gap-4.5">
                  ...
                  <div className="text-gray-600 text-sm">
                    ...
                    <a href="tel:+0995327869843" className="hover:text-gray-800 transition-colors">{contactsQuery.data?.data?.contacts?.phone}</a>
                  </div>
                </li>}

              {contactsQuery.data?.data?.contacts?.email &&
                <li className="flex gap-4.5">
                  ...
                  <div className="text-gray-600 text-sm">
                    ...
                    <a href={"mailto:" + contactsQuery.data?.data?.contacts?.email} className="hover:text-gray-800 transition-colors">{contactsQuery.data?.data?.contacts?.email}</a>
                  </div>
                </li>}
            </ul>
            ...
            <div className="flex items-center gap-3 mt-7.5">
              {contactsQuery.data?.data?.contacts?.facebook &&
                <a
                  href={contactsQuery.data?.data?.contacts?.facebook}
              ...
              {contactsQuery.data?.data?.contacts?.twitter &&
                <a
                  href={contactsQuery.data?.data?.contacts?.twitter}
              ...
              {contactsQuery.data?.data?.contacts?.instagram &&
                <a
                  href={contactsQuery.data?.data?.contacts?.instagram}
              ...
              {contactsQuery.data?.data?.contacts?.youtube &&
                <a
                  href={contactsQuery.data?.data?.contacts?.youtube}
